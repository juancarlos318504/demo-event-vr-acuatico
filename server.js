...
//     res.send('Supermercado virtual hoyostools');
// });
...
easyrtc.listen(app, socketServer, null, (err, rtcRef) => {
    ...
    app.get('/autenticacion', function (req, res) {
        res.sendFile(path.join(__dirname, 'public', 'login.html') );
    });

    app.get('/personalizacion', function (req, res) {
    ...
    app.get('/experiencia', function (req, res) {
        ...
        // res.sendFile('./public/experience.html');
    });
